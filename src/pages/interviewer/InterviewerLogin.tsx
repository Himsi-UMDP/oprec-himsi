    ...
    async function handleLogin(e: React.FormEvent) {
        ...
        try {
            ...
            if (!itvData) {
                ...
                throw new Error('Akun ini tidak terdaftar sebagai pewawancara.')
            }
            navigate('/interviewer/panel')
        } catch (err) {
            ...
            <div className="w-full max-w-md">
                <div className="text-center mb-8">
                    ...
                    <h1 className="text-2xl font-bold text-foreground">
                        Login <span className="text-[#2464a8]">Pewawancara</span>
                    </h1>
                    <p className="text-sm text-muted-foreground mt-1 font-semibold">
                        Portal penilaian wawancara HIMSI UMDP 2026/2027
                    </p>
                </div>
                    ...
                    <form onSubmit={handleLogin} className="space-y-5" noValidate>
                        <div className="space-y-2">
                            ...
                            <input
                                ...
                                placeholder="pewawancara@mhs.mdp.ac.id"
