export const OPREC_OPEN_AT = new Date("2026-03-04T15:00:00+07:00"); 
export const OPREC_CLOSE_AT = new Date("2026-03-12T23:59:00+07:00"); 
...
// export const OPREC_ANNOUNCE_AT = new Date(Date.now() + 1 * 60_000);     // 1 jam lagi (belum announce)
